...
public class FolderAdapter extends RecyclerView.Adapter<FolderAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(mLayoutInflater.inflate(R.layout.gallery_pick_gallery_item_folder, parent, false));
    }

    @Override
    public void onBindViewHolder(final ViewHolder holder, int position) {
        if (position == 0) {
            holder.tvGalleryFolderName.setText(mContext.getString(R.string.gallerypickgallery_all_folder));
            holder.tvGalleryPhotoNum.setText(mContext.getString(R.string.gallerypickgallery_photo_num, getTotalImageSize()));
            if (result.size() > 0) {
        ...
        holder.tvGalleryPhotoNum.setText(mContext.getString(R.string.gallerypickgallery_photo_num, folderInfo.photoInfoList.size()));
